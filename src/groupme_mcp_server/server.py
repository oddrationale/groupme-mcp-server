...
INSTRUCTIONS = """\
Tools for reading GroupMe conversations via the GroupMe API v3.
...
member list, and recent messages in one call. Every tool accepts
response_format="concise" (default, human-readable) or "detailed" (full
ids and metadata). Requests need a GROUPME_ACCESS_TOKEN in the server's
environment.
"""
